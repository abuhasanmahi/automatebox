<p><strong>{HOST_NAME}</strong> respects the intellectual property of others. <strong>{HOST_NAME}</strong> takes matters of Intellectual Property very seriously and is committed to meeting the needs of content owners while helping them manage publication of their content online. It should be noted that <strong>{HOST_NAME}</strong> is a simple search engine of TV series available at a wide variety of third party websites.</p>
